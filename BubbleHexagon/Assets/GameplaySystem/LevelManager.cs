...
public class LevelManager : MonoBehaviour
{
    ...
    public ProbabilityConfiguration[] shootConfigsEasy;

    public ProbabilityConfiguration[] shootConfigsHard;

    ProbabilityConfiguration[] shootConfig;
    ProbabilityConfiguration[] shootConfigEmpty;
